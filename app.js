...
const ACT_DETAILS = {
  ...
  act3: {
    ...
    referencePart: "Piano",
    songShortcuts: [
      { label: "Blow High, Blow Low", time: 0 },
      { label: "June Is Bustlin' Out All Over", time: 49 },
      { label: "Geraniums In The Winder", time: 93 },
      { label: "What's The Use Of Wondr'in?", time: 124 },
      { label: "Soliloquy", time: 142 },
      { label: "If I Loved You", time: 176 },
      { label: "Highest Judge", time: 241 },
      { label: "A Real Nice Clambake", time: 251 },
      { label: "Carousel Waltz", time: 284 },
      { label: "When I Marry Mr. Snow", time: 292 },
      { label: "When The Children Are Asleep", time: 341 },
      { label: "Finale - Look Afar", time: 399 },
      { label: "You'll Never Walk Alone", time: 427 },
    ],
    parts: [
      { label: "Soloists", group: "non singing parts", fileName: "Act3_Soloists.mp3" },
      { label: "Winds", group: "non singing parts", fileName: "Act3_Winds.mp3" },
      { label: "Percussion", group: "non singing parts", fileName: "Act3_Percussion.mp3" },
      { label: "Piano", group: "non singing parts", fileName: "Act3_Piano.mp3" },
      { label: "Soprano", group: "singing parts", fileName: "Solo_Act3Soprano.mp3" },
      { label: "Alto", group: "singing parts", fileName: "Solo_Act3Alto.mp3" },
      { label: "Tenor", group: "singing parts", fileName: "Solo_Act3Tenor.mp3" },
      { label: "Bass", group: "singing parts", fileName: "Solo_Act3Bass.mp3" },
    ],
  },
};
